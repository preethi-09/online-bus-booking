                        ...
                        <div class="jumbotron">
                            <div class="container-fluid">
                                ...
                                <form action="" method="post" class="form-horizontal">
                                    ...
                                    <button class="btn-xs btn-primary" name="submit" style="margin-left: 5px;">GO</button>

                                </form>
                                <?php 

                                if (isset($_POST['passenger_count'])) {
                                    $busCount = $_POST['passenger_count'];
                                }else{
                                ...
                                ?>
                                <form action="bus_info.php?bus_id=<?php echo $selected_bus; ?>&count=<?php echo $busCount; ?>" method="POST" class="form-horizontal">
